...
echo 'vmess://'$(echo '{"add":"47.52.57.57","aid":"0","host":"'$argo'","id":"1B8B9065-DC8A-4CCC-89C5-821CCC137442","net":"ws","path":"/","port":"443","ps":"Zrgo_vme$$","tls":"tls","type":"none","v":"2"}' | base64 -w 0)
